...
//       <Path
//         d="M110,60 L120,60 L130,60"
//         stroke="#000"
//         strokeWidth="2"
//         strokeDasharray="5,5"
//       />{' '}
//       {/* Deck detail */}
//       <Path d="M90,20 L90,30 L110,30 L110,20" fill="#fff" opacity="0.7" />{' '}
//       {/* Cloud */}
//       <Path
//         d="M115,25 L115,35 L135,35 L135,25"
//         fill="#fff"
//         opacity="0.7"
//       />{' '}
//       {/* Cloud */}
...
//   <Text>
//     <Svg width={240} height={120} viewBox="0 0 240 120" fill="none">
//       <Rect x="70" y="40" width="100" height="70" rx="5" fill="#FFFFFF" />{' '}
//       {/* Notebook */}
...
//       <Path
//         d="M90,75 L110,75 Q115,70 120,75 Q125,80 130,75"
//         stroke="#34A853"
//         strokeWidth="2"
//       />{' '}
//       {/* Drawing */}
//       <Path
//         d="M150,60 L140,60 Q135,65 130,60"
//         stroke="#4285F4"
//         strokeWidth="2"
//       />{' '}
//       {/* Drawing */}
...
//       <Path d="M95,70 L105,60 L115,70 Z" fill="#FFFFFF" opacity="0.7" />{' '}
//       {/* Snow feature */}
//       <Path d="M125,65 L135,55 L145,65 Z" fill="#FFFFFF" opacity="0.7" />{' '}
//       {/* Snow feature */}
...
//       <Rect x="80" y="80" width="80" height="10" fill="#E0E0E0" />{' '}
//       {/* Step 1 */}
//       <Rect x="90" y="70" width="60" height="10" fill="#E57373" />{' '}
//       {/* Step 2 */}
//       <Rect x="100" y="60" width="40" height="10" fill="#E57373" />{' '}
//       {/* Step 3 */}
//       <Rect x="105" y="50" width="30" height="10" fill="#E57373" />{' '}
//       {/* Step 4 */}
//       <Rect x="110" y="40" width="20" height="10" fill="#E57373" />{' '}
//       {/* Step 5 */}
//       <Circle cx="120" cy="30" r="8" fill="#333" /> {/* Head */}
//       <Rect x="110" y="38" width="20" height="20" fill="#64B5F6" rx="5" />{' '}
//       {/* Body */}
//       <Path d="M110,45 L100,55" stroke="#64B5F6" strokeWidth="5" />{' '}
//       {/* Left arm */}
//       <Path d="M130,45 L140,55" stroke="#64B5F6" strokeWidth="5" />{' '}
//       {/* Right arm */}
//       <Path d="M115,58 L115,75" stroke="#4CAF50" strokeWidth="5" />{' '}
//       {/* Left leg */}
//       <Path d="M125,58 L125,75" stroke="#4CAF50" strokeWidth="5" />{' '}
//       {/* Right leg */}
//       <Circle cx="150" cy="60" r="6" fill="#FFFFFF" /> {/* Trophy top */}
//       <Rect x="147" y="66" width="6" height="4" fill="#FFFFFF" />{' '}
//       {/* Trophy neck */}
//       <Path d="M144,70 L156,70 L154,75 L146,75 Z" fill="#FFFFFF" />{' '}
//       {/* Trophy base */}
//     </Svg>
//   </Text>
// );
...
const SLIDES = [
  {
    ...
    description:
      "The less disciplined you are, the less productive you are, the worse you feel. Realize you're in a spiral and escape it.",
  ...
  },
  {
    ...
    description:
      'A system does. Rise creates a focused environment for you to overcome distraction and challenges, to rebuild your life.',
    background: '#D32F2F', // Bright red
    illustration: () => null,
  },
  {
    ...
    description:
      "What you're about to do is not easy. You're going to miss tasks. But it's okay - every day is a new day. Our progress will tell.",
    background: '#D32F2F', // Bright red
    illustration: () => null,
  },
  {
    ...
    description:
      "The life reset program is a scientific and systemic way to help you rebuild your discipline and motivation. We're here to help.",
