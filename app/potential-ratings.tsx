...
export default function PotentialRatingsScreen() {
  ...
  const { updateSubscription, userData } = useGlobal();
  ...
  Object.keys(currentMetrics).forEach((key) => {
    ...
    potentialMetrics[metricKey] = Math.min(
      100,
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>
            ...
            <Text style={styles.highlight}>
              {potentialOverall} potential rating
            </Text>{' '}
          ...
          <View style={[styles.scoreCard, { backgroundColor: '#F37335' }]}>
            ...
            <View style={styles.scoreBarContainer}>
              <View
                style={[
                  styles.scoreBar,
                  { width: `${Math.min(100, potentialOverall)}%` },
                ]}
              />
            </View>
          </View>
          ...
          <Pressable
            style={[styles.ctaButton, isSubscribed && styles.subscribedButton]}
            onPress={handleSubscribe}
          >
            <Text style={styles.ctaButtonText}>
              {isSubscribed
                ? 'Begin Your Program!'
                : 'Subscribe now and begin!'}
            </Text>
          </Pressable>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  subscribedButton: {
    backgroundColor: '#4CAF50', // Green color for subscribed state
  },
  ctaButtonText: {
    color: '#fff',
    fontSize: 18,
